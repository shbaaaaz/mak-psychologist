...
const MobileMenu = ({ menu }: {menu: NavMenuItem[]}) => {
  ...
  return (
    ...
    <nav className={`py-10 w-screen h-screen bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-100 transition-transform ease-in-out duration-500 transform fixed top-0 left-0 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full' }`}>
